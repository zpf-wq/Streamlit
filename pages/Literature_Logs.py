...
class ExperimentApp:
    ...
    def enter_text(self):
        ...
        try:
            if st.button('Save'):
                with open(f"/Users/zhangpengfei/PycharmProjects"
    ...
    def save_images(self, image_files, image_name):
        for i in range(0, len(image_files)):
            try:
                ...
                img.convert('RGB')
                img_path = os.path.join(f"/Users/zhangpengfei/PycharmProjects"
    ...
    def save_code(self, code_files, code_name):
        save_dir = f"/Users/zhangpengfei/PycharmProjects/StreamProject/Code/{str(self.day)}"
